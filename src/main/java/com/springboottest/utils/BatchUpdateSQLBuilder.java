...
/**
 * 拼接批量更新语句工具类 只支持javaBean, 不支持其他任何java类, 否则报错
 */
public class BatchUpdateSQLBuilder<T> {
    ...
    // 设置表名
    public com.springboottest.utils.BatchUpdateSQLBuilder setUpdateTable(String tableName, String primaryKey) {
    ...
    // 设置是否为全量更新
    public com.springboottest.utils.BatchUpdateSQLBuilder setSelective(boolean selective) {
    ...
    public com.springboottest.utils.BatchUpdateSQLBuilder setData(T obj) {
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            ...
            sb.append(com.springboottest.utils.SQLUtil.humpToUnderline(getBeanFieldName(field))).append(EQUAL);
            ...
            while (iterator.hasNext()) {
                ...
                try {
                    Field primary = clazz.getDeclaredField(com.springboottest.utils.SQLUtil.underlineTohump(primaryKey));
