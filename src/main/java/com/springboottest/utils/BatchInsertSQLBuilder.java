...
/**
 * 拼接批量插入语句工具类 只支持javaBean, 不支持其他任何java类, 否则报错
 */
public class BatchInsertSQLBuilder<T> {
    ...
    // 设置表名
    public com.springboottest.utils.BatchInsertSQLBuilder setInsertTable(String tableName) {
    ...
    // 设置是否为全量更新
    public com.springboottest.utils.BatchInsertSQLBuilder setSelective(boolean selective) {
    ...
    public com.springboottest.utils.BatchInsertSQLBuilder setData(T obj) {
    ...
    public String toString() {
        ...
        while (iterator.hasNext()) {
            ...
            sb.append(com.springboottest.utils.SQLUtil.humpToUnderline(getBeanFieldName(field)));
            if (iterator.hasNext()) {
